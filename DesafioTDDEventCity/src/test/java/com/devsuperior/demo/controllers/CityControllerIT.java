...
public class CityControllerIT {
	...
	public void findAllShouldReturnAllResourcesSortedByName() throws Exception {
		...
		result.andExpect(jsonPath("$.content[0].name").value("São Paulo"));
		result.andExpect(jsonPath("$.content[1].name").value("Brasília"));
		result.andExpect(jsonPath("$.content[2].name").value("Fortaleza"));
	}
